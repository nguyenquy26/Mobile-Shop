                                            ...
                                            <div class="col-12" id="factoryFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-3"
                                                        value="ViVo">
                                                    <label class="form-check-label" for="factory-3">ViVo</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-4"
                                                        value="Realme">
                                                    <label class="form-check-label" for="factory-4">Realme</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-5"
                                                        value="Oppo">
                                                    <label class="form-check-label" for="factory-5">Oppo</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-6"
                                                        value="Xiaomi">
                                                    <label class="form-check-label" for="factory-6">Xiaomi</label>
                                                </div>

                                            </div>
                                            <div class="col-12" id="targetFilter">
                                                <div class="mb-2"><b>RAM - BỘ NHỚ TRONG</b></div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-1"
                                                        value="4GB128GB">
                                                    <label class="form-check-label" for="target-1">4GB-128GB</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-2"
                                                        value="8GB128GB">
                                                    <label class="form-check-label" for="target-2">8GB-128GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-3"
                                                        value="8GB256GB">
                                                    <label class="form-check-label" for="target-3">8GB-256GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="12GB256GB">
                                                    <label class="form-check-label" for="target-4">12GB-256GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-5"
                                                        value="4GB64GB">
                                                    <label class="form-check-label" for="target-5">4GB-64GB</label>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="rounded position-relative fruite-item">
                                                        ...
                                                        <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                            style="top: 10px; left: 10px;">Mobile
                                                        </div>
                                                        <div
